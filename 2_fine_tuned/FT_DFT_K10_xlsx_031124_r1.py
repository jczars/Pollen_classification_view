...
def process_train(_config_train, verbose=1):
    ...
    return model_tl, val_loss, val_accuracy, res_train['history'], res_train['start_time'], res_train['end_time'], res_train['duration'], res_train['best_epoch']
...
def save_results(row, k, val_loss, val_accuracy, me, start_time, end_time, duration, best_epoch, path_xlsx):
    """
    ...
    data = [
        ...
        duration, end_time, duration, best_epoch, script_name
    ]
...
if __name__ == "__main__":
    ...
    default_path_sheet = "/media/jczars/4C22F02A22F01B22/$WinREAgent/Pollen_classification_view/2_fine_tuned/Reports/0_Test_reports_101124.xlsx"
    ...
    """_exemple
        ...
        python FT_DFT_K10_xlsx_031124_r1.py "/media/jczars/4C22F02A22F01B22/$WinREAgent/Pollen_classification_view/2_fine_tuned/Reports/0_Test_reports_101124.xlsx"
    """
