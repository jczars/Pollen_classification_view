...
from models import split_BD_vistas_k, balanc_BD_vistas_k, sound_test_finalizado
...
def process_augmentation(config):
    ...
    split_BD_vistas_k.run_split(config)
    ...
    for view in views:
        ...
        balanc_BD_vistas_k.run_balancing(dst_base, categories, goal, tipo, k_folds, save_dir, verbose=verbose)
